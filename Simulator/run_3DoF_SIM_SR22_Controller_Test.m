...
states_init = [0 1000 2.2/57.3 157.50*1.852/3.6 0 0];  % initial conditions H=ft, Vx=kts
...
throttle = 0.4; % currently not implemented 
...
opspec.States(2).x = -1227; 
opspec.States(2).Known = true;            % fix it
