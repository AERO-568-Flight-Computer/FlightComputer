# The following script allows the user to control the position of the Stirling Inceptor device.
...
def main():
    ...
    try:
        ...
        ngi.move_joystick_to_position(pitch_pos=0, roll_pos=0) # Define and control joystick position HERE
